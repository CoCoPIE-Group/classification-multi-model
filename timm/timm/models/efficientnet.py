...
@register_model
def efficientnet_b0_c07(pretrained=False, **kwargs):
    """ EfficientNet-B0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet(
        'efficientnet_b0_c07', channel_multiplier=0.7, depth_multiplier=1.0, pretrained=pretrained, **kwargs)
    return model
